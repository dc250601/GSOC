...
def EfficientNet(
  ...
  # Build stem
  #Some Changes are made here to accomodate the new hybrid architecture
  x = img_input
  ...
  #'-------------------------------------------------------------------------------
    if feature_extractor_blocks !=None and i>feature_extractor_blocks :
        break
  #-------------------------------------------------------------------------------
